  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          title="Market Research & Progress Update"
          icon={<AceternityIcon order="Phase 2" />}
          des="Once we finalize the strategy, I'll focus on researching and understanding your textile markets, keeping you updated on all the essential trends and product positioning."
        >
          <CanvasRevealEffect
            animationSpeed={3}
